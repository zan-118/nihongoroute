/**
 * @file MobileNav.tsx
 * @description Premium mobile bottom navigation bar component featuring cyber-glass styling and active indicators.
 */
...
export default function MobileNav() {
 ...
 <nav className="bg-card border-t border-border shadow-lg rounded-lg p-1.5 transition-all duration-500 overflow-hidden relative">
