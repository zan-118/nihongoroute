 ...
 * @description User authentication status, profile summary, theme toggle, and logout section for the sidebar footer.
 */
...
export function UserStatusSection({
 ...
 return (
 <div className="space-y-4">
 <div className="bg-card border border-border transition-colors hover:border-primary/40 flex items-center gap-3 p-3 rounded-lg group">
