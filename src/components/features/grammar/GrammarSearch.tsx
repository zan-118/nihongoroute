...
/**
 * Komponen input pencarian untuk tata bahasa dilengkapi toggle layout.
 */
export function GrammarSearch({ value, onChange }: GrammarSearchProps) {
  ...
  return (
    <div className="mb-10 md:mb-16 flex flex-col sm:flex-row gap-4 items-stretch sm:items-center w-full">
      <div className="relative group flex-1">
        ...
        <Input
          ...
          className="w-full pl-14 md:pl-16 pr-8 py-5 md:py-7 h-auto bg-[rgba(var(--card-rgb),0.4)] backdrop-blur-xl border border-border rounded-2xl md:rounded-[2rem] text-sm md:text-lg text-foreground placeholder:text-muted-foreground/30 font-bold shadow-2xl focus-visible:ring-primary/30 focus-visible:border-primary/50 transition-all duration-500"
          value={value}
