...
export function LibraryServerStatus() {
  return (
    <Card className="p-8 md:p-10 rounded-3xl md:rounded-[3.5rem] bg-[rgba(var(--card-rgb),0.3)] backdrop-blur-sm border-border neo-card shadow-none min-w-[320px] font-sans">
