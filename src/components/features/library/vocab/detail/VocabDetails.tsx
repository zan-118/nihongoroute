...
export function VocabDetails({ hinshi, jlptLevel, pitchAccent }: VocabDetailsProps) {
  return (
    <Card className="p-6 bg-card/20 backdrop-blur-xl border-border rounded-[2rem] hover:border-primary/40 transition-all group overflow-hidden relative col-span-1 flex flex-col justify-center gap-4 font-sans">
