...
export default function UpdatePasswordClient() {
  ...
  return (
    <div className="min-h-screen shell-ambient text-foreground flex items-center justify-center p-4 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="w-full max-w-md bg-card/85 border border-border/80 rounded-xl p-8 z-10 shadow-[0_15px_50px_rgba(var(--foreground-rgb),0.3)] hover:shadow-[0_20px_60px_rgb(var(--brand-cyan-rgb)/0.14)] transition-all duration-500 relative glass">
