...
export default function NotFound() {
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center shell-ambient p-6 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="z-10 flex flex-col items-center text-center max-w-md w-full glass border border-border rounded-[2rem] p-8 md:p-12 shadow-[0_20px_50px_rgba(var(--foreground-rgb),0.3)]">
