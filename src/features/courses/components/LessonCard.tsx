...
export function LessonCard({ lesson, index, categoryId, isSideQuest, progress = 0 }: LessonCardProps) {
 ...
 <Card
      className="p-6 sm:p-7 md:p-8 rounded-2xl transition-all duration-500 flex flex-col items-start gap-4 cursor-pointer h-full relative overflow-hidden bg-card border border-border/50 dark:border-white/10 shadow-sm"
 style={{
 ...
 {(index + 1).toString().padStart(2, "0")}
        ...
        {progress > 0 && (
          <div
            className="px-2 py-0.5 sm:px-3 sm:py-1 rounded-[4px] border text-[8px] sm:text-[9px] font-bold uppercase tracking-wider transition-all duration-300 shadow-sm"
            style={{
      ...
      {/* Bottom Progress Bar: Clean Token Style */}
