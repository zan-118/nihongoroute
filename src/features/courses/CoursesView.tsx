      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
          ...
          >
            ...
            <Card className="h-full bg-card border border-border/50 dark:border-white/10 rounded-2xl p-8 sm:p-10 md:p-14 relative overflow-hidden shadow-sm">
              ...
              <div className="relative z-10 flex flex-col xl:flex-row xl:items-center justify-between gap-8 md:gap-12">
                <div className="space-y-4 max-w-2xl">
                  <div className="flex items-center gap-3">
                    <Badge variant="outline" className="bg-primary/5 text-primary border-primary/20 px-3.5 py-1 rounded-[4px] text-[9px] font-bold uppercase tracking-wider shadow-none">
                      Direktori Belajar
                    </Badge>
                  </div>
                ...
                <div className="w-full xl:w-auto xl:min-w-[320px] p-6 rounded-lg bg-card border border-border/80 relative overflow-hidden transition-all duration-500 hover:border-primary/45 shadow-sm">
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs font-bold text-primary font-mono">{globalProgress}%</span>
                    </div>
                    ...
                    <div className="flex justify-between items-center gap-4 pt-1">
                      <div className="flex items-center gap-1.5">
                        <span className="text-base font-bold text-foreground">{lessonsDoneCount}</span>
                        <span className="text-[8px] font-bold uppercase tracking-wider text-muted-foreground">Selesai</span>
                      </div>
                      <div className="w-1.5 h-1.5 rounded-full bg-border" />
                      <div className="flex items-center gap-1.5">
                        <span className="text-base font-bold text-foreground">{totalLessons}</span>
                        <span className="text-[8px] font-bold uppercase tracking-wider text-muted-foreground">Total Materi</span>
                      </div>
                      <div className="w-1.5 h-1.5 rounded-full bg-border" />
                      <div className="flex items-center gap-1.5">
                        <span className="text-base font-bold text-foreground">{categories.length}</span>
                        <span className="text-[8px] font-bold uppercase tracking-wider text-muted-foreground">Rute</span>
                      </div>
                    </div>
                  </div>
                </div>
