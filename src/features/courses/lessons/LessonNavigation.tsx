...
export const LessonNavigation: React.FC<LessonNavigationProps> = ({ 
 ...
 className="neo-card h-full p-8 group flex flex-col justify-center items-start hover:bg-[hsl(var(--primary)/0.05)] hover:border-[hsl(var(--primary)/0.3)] transition-all duration-300"
 >
 ...
 className="neo-card h-full p-8 group flex flex-col justify-center items-end text-right hover:bg-[hsl(var(--primary)/0.05)] hover:border-[hsl(var(--primary)/0.3)] transition-all duration-300"
 >
 ...
 className="neo-card h-full p-8 flex flex-col items-center justify-center text-center group bg-[hsl(var(--primary)/0.05)] hover:bg-[hsl(var(--primary)/0.1)] border-[hsl(var(--primary)/0.2)] hover:border-primary transition-all duration-300"
 >
