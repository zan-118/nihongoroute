...
const PdfGenerator = dynamic(() => import("../PdfGenerator"), {
  ssr: false,
  loading: () => (
    <Button variant="ghost" disabled className="bg-background/40 border border-border neo-inset shadow-none px-8 py-4 rounded-2xl text-muted-foreground text-xs font-black uppercase tracking-wider flex items-center justify-center gap-3 w-full sm:w-auto h-auto italic">
