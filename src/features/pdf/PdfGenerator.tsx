 ...
 * @description React PDF renderer document generator component.
 * Uses dynamic imports for `PDFDownloadLink` to optimize initial JavaScript bundle size,
 * providing templates for Lessons, Vocab, Certificates, Cheatsheets, and Grammar.
 *
