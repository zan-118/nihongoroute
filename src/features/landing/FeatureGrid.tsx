 ...
 * @description Landing page feature grid component showcasing learning ecosystem, interactive playgrounds, and gamification highlights.
 */
...
export function FeatureGrid() {
 ...
 <div className="relative w-11 h-14 text-primary-foreground rounded-lg flex items-center justify-center font-bold text-xl shadow-sm shrink-0 transition-transform group-hover:scale-105">
 猫
 ...
 <div className="w-12 h-12 rounded-xl flex items-center justify-center font-bold text-base bg-primary text-slate-950 dark:text-primary-foreground shadow-[0_4px_12px_rgb(var(--primary)_/_0.3)]">
 0{idx + 1}
 </div>
 ...
 <span className="text-primary">Sistem Belajar Interaktif</span>
 </h2>
 ...
 "bg-success/80 border border-success/60 shadow-[0_0_6px_hsl(var(--success)/0.35)]",
 ];
