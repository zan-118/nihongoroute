/**
 * @file Hero.tsx
 * @description Landing page hero section component featuring value proposition, CTA buttons, and brand badge.
 */
 ...
 * Displays branding, value proposition, call- buttons, and decorative elements.
 * 
...
export function Hero() {
 ...
 <Badge variant="outline" className="bg-card border border-border text-foreground px-3 py-1 rounded-full text-sm shadow-none">
 ...
 <div className="hidden lg:flex flex-1 justify-end relative pointer-events-none animate-in fade-in slide-in- duration-700">
 ...
 <Sparkles className="text-primary drop-shadow-[0_0_16px_hsl(var(--primary)/0.45)]" size={24} />
 </div>
