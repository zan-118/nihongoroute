...
import { Save, Upload, DeleteBin, LoginBox, Database } from "@/components/ui/icons";
...
export default function DataManagementSection({
 ...
 className="h-16 bg-background/50 border border-border/80 hover:bg-primary/10 hover:border-primary/40 hover:text-primary text-muted-foreground rounded-lg rounded-br-none uppercase tracking-[0.2em] font-black text-[10px] transition-all duration-200 group/btn shadow-sm"
 >
 <Upload size={18} className="mr-3 group-hover/btn:scale-110 group-hover/btn:text-primary transition-all text-muted-foreground/70" /> Impor Backup
 </Button>
 ...
 >
 <DeleteBin size={18} className="mr-3 group-hover/btn:scale-110 group-hover/btn:text-destructive transition-all text-destructive/70" /> Hapus Semua Data
 </Button>
 ...
 >
 <LoginBox size={18} className="mr-3 group-hover:translate-x-1 transition-transform text-muted-foreground/70 group-hover:text-foreground" /> Keluar Akun
 </Button>
 )}
 </div>
 </Card>
