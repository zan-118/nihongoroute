...
export function SurvivalIntro({ startGame }: SurvivalIntroProps) {
 ...
 <Card className="w-20 h-20 md:w-28 md:h-28 mx-auto bg-muted/50 dark:bg-background/40 border border-border dark:border-primary/20 rounded-2xl md:rounded-3xl flex items-center justify-center mb-8 md:mb-12 neo-inset shadow-none group-hover:border-primary/40 transition-all duration-200">
 <Pulse
 size={40}
 aria-hidden="true"
 className="text-primary drop-shadow-sm dark:drop-shadow-sm md:w-12 md:h-12"
 />
 </Card>
 <h2 className="text-4xl md:text-6xl lg:text-7xl text-foreground tracking-tight mb-6 md:mb-8 leading-none">
 Mode <span className="text-primary drop-shadow-sm dark:drop-shadow-sm">Evaluasi</span>
 </h2>
