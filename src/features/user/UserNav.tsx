...
export default function UserNav() {
 ...
 <Button 
 asChild 
 className="h-10 px-3 sm:px-4 rounded-xl bg-primary text-primary-foreground hover:bg-primary/92 text-[10px] sm:text-xs"
 >
 ...
 <DropdownMenuContent className="w-56 mt-2 p-2 bg-card border border-border rounded-lg shadow-2xl animate-in fade-in zoom-in-95 duration-200">
