 ...
 * @description Compact weak point summary card component for Dashboard Home tab.
 * Displays top 3 weak points derived from `buildWeakPointInsights` with CTA link to the trainer tool.
 * @storeAccess Accesses `useUIStore` (learningEvents).
