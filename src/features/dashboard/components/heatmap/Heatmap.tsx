...
/**
 * @file Heatmap.tsx
 * @description User study activity Heatmap component for Dashboard.
 * Displays a 35-day grid of vocabulary and Kanji review activity with color-coded intensity levels and Framer Motion tooltips.
