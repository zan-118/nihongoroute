...
export default function WeakPointPanel() {
 ...
 return (
 <Card className="relative overflow-hidden bg-card/30 border border-border rounded-2xl p-6 md:p-8 transition-all duration-300 hover:shadow-sm shadow-none">
 <div className="absolute top-0 right-0 size-24 bg-success/5 blur-3xl rounded-full" />
 <div className="flex items-center gap-4">
        <div className="size-10 rounded-full bg-success/10 border border-success/20 flex items-center justify-center text-success shadow-sm">
          <Check size={20} className="text-success" />
        </div>
 <div>
 <h4 className="text-xs uppercase tracking-wider text-success">Status: Semua Sistem Optimal</h4>
 ...
 return (
 <Card className="relative overflow-hidden bg-card/30 border border-border rounded-2xl p-6 md:p-8 transition-all duration-500 hover:border-destructive/20 hover:shadow-sm shadow-none">
 ...
 <div>
 <h2 className="text-destructive uppercase tracking-wider text-xs mb-2 flex items-center gap-2">
 ...
 <Badge variant="outline" className="bg-destructive/10 border-destructive/20 text-destructive text-[8px] font-black uppercase tracking-wider px-3 py-1.5 h-auto">
 {weakItems.length} Titik Lemah
 </Badge>
 <Button asChild size="sm" className="h-8 rounded-xl px-3 text-[8px] font-black uppercase tracking-wider">
 ...
 isCritical
 ? "bg-destructive/[0.03] border-destructive/20 hover:bg-destructive/[0.06] hover:border-destructive/35 hover:shadow-sm animate-[pulse_5s_infinite]"
 ...
 <div className="flex justify-between text-[6px] font-black uppercase tracking-wider text-destructive/70 font-mono">
 ...
 <div 
 className="bg-destructive h-full rounded-full shadow-sm relative overflow-hidden before:absolute before:inset-0 before:-translate-x-full before:animate-[shimmer_2s_infinite] before:bg-white/30" 
