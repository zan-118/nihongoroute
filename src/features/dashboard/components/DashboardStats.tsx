 ...
 * @description Dashboard main stats widget container summarizing XP progress, streak counters, JLPT curriculum mastery, Daily Quests, Memory Stats, SRS Analytics, and study Heatmaps.
