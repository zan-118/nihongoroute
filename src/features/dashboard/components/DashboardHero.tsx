 ...
 * @description Dashboard Hero component rendering personalized greetings, SRS review status summaries, XP level progress indicators, streak badges, and quick review CTA buttons.
