...
/**
 * @file HomePanel.tsx
 * @description Dashboard main Home tab panel component integrating DashboardHero, Kanji mastery grid, Daily Quests, and Daily Expression spotlight.
...
import DailyRoutePanel from "@/features/ecosystem/DailyRoutePanel";
import NextActionPanel from "@/features/ecosystem/NextActionPanel";
import WeakPointSummary from "../WeakPointSummary";
 ...
 * kanji progress, daily quests, dan daily expression.
 */
