...
export function GrammarSearch({ value, onChange }: GrammarSearchProps) {
 ...
 <div className="flex p-1.5 bg-[hsl(var(--card)/0.4)] rounded-lg border border-border h-[52px] sm:h-[60px] items-center gap-1.5 px-3 shrink-0 glass">
 <Button
 type="button"
 variant="ghost"
