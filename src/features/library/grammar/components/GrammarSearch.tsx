...
export function GrammarSearch({ value, onChange }: GrammarSearchProps) {
 ...
 className="w-full pl-14 md:pl-16 pr-8 py-5 md:py-7 h-auto bg-card/40 border border-border rounded-lg md:rounded-3xl text-sm md:text-lg text-foreground placeholder:text-muted-foreground/30 font-bold shadow-2xl focus-visible:ring-primary/30 focus-visible:border-primary/50 transition-all duration-500 font-sans glass"
 value={value}
 ...
 <div className="flex p-1.5 bg-card/40 rounded-lg border border-border h-[52px] sm:h-[60px] items-center gap-1.5 px-3 shrink-0 glass">
 <Button
 type="button"
 variant="ghost"
