 ...
 * 
 * @param {WordPopoverProps} props Component properties.
 * @returns {React.ReactElement} Trigger wrapper and interactive popover drawer/modal.
 */
 ...
 */
 ...
 className={cn(
 "cursor-pointer transition-all duration-300 decoration-primary/20 decoration-2 underline-offset-4",
