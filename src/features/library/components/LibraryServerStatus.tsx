 ...
 * @description Visualizer component displaying offline learning module readiness status using CSS animations and cyber-glass aesthetics.
...
export function LibraryServerStatus() {
 return (
 <Card className="p-8 md:p-10 rounded-2xl md:rounded-3xl border border-border bg-[hsl(var(--card)/0.35)] shadow-[0_0_50px_hsl(var(--primary)/0.02)] min-w-[320px] font-sans glass">
 ...
 {[...Array(6)].map((_, i) => (
 <div key={`bar-${i}`} className="flex-1 h-12 md:h-14 bg-[hsl(var(--primary)/0.08)] border border-border/30 rounded-full overflow-hidden flex items-end">
 <div 
