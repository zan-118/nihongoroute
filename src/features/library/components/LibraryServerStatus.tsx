...
export function LibraryServerStatus() {
 return (
 <Card className="p-8 md:p-10 rounded-2xl md:rounded-3xl border border-border bg-card/35 shadow-sm min-w-[320px] font-sans glass">
 ...
 {[...Array(6)].map((_, i) => (
 <div key={`bar-${i}`} className="flex-1 h-12 md:h-14 bg-primary/8 border border-border/30 rounded-full overflow-hidden flex items-end">
 <div 
