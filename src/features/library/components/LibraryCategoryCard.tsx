 ...
 * @description Komponen kartu navigasi kategori pustaka belajar NihongoRoute.
 * Menyajikan visualisasi clean, lapang di desktop, dan sangat responsif di mobile.
 */
