...
export function VocabCard({ item, showRomaji }: VocabCardProps) {
 ...
 <div className="text-foreground font-japanese leading-tight group-hover:text-primary transition-colors">
 <SmartJapanese word={item.word} furigana={item.furigana || undefined} size="large" />
 </div>
