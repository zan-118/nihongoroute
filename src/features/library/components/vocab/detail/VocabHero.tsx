...
export function VocabHero({ word, furigana, romaji, meaning, audioUrl }: VocabHeroProps) {
  return (
    <div className="w-full p-2.5 rounded-5xl bg-card/40 dark:bg-card/20 backdrop-blur-2xl border border-border/60 dark:border-white/10 shadow-2xl relative overflow-hidden font-sans group">
      ...
      <div className="w-full h-full rounded-[1.875rem] p-8 sm:p-12 md:p-16 bg-linear-to-b from-background/95 via-background/80 to-background/95 dark:from-[#080d14]/95 dark:to-[#05080e]/95 border border-border/30 dark:border-white/5 shadow-[inset_0_1px_1px_rgba(255,255,255,0.12)] flex flex-col items-center text-center relative z-10">
        ...
        {/* Glowing Divider Bar */}
        <div className="h-1.5 w-20 bg-linear-to-r from-primary via-cyan-400 to-emerald-400 rounded-full mb-6 shadow-[0_0_20px_rgba(0,122,124,0.6)]" />
