 ...
 * @description Interactive onboarding wizard view component configuring initial user profiles, target JLPT levels, and study goals.
...
export default function OnboardingView() {
 ...
 <Button 
 onClick={() => setStep(2)}
 className="bg-primary text-primary-foreground hover:bg-primary/92 rounded-2xl px-10 h-14 text-base"
 >
 ...
 className="bg-primary text-primary-foreground hover:bg-primary/92 rounded-xl px-8 h-12"
 >
 {isSubmitting ? (
 <>
