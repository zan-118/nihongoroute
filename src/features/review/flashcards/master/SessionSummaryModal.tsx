 ...
 */
 ...
 if (accuracy >= 90) return { title: "Luar Biasa!", color: "text-success", bg: "bg-success/5 border-success/20 dark:shadow-[0_0_20px_hsl(var(--success)/0.1)]" };
 if (accuracy >= 70) return { title: "Bagus Sekali!", color: "text-warning", bg: "bg-warning/5 border-warning/20 dark:shadow-[0_0_20px_hsl(var(--warning)/0.1)]" };
 return { title: "Mari Terus Latihan!", color: "text-primary", bg: "bg-primary/5 border-primary/20 dark:shadow-[0_0_20px_hsl(var(--primary)/0.1)]" };
 };
 ...
 */
 ...
 <div className="w-16 h-16 md:w-20 md:h-20 mx-auto bg-[hsl(var(--muted)/0.5)] dark:bg-[hsl(var(--background)/0.04)] rounded-xl flex items-center justify-center border border-border mb-6 shadow-none">
 <Trophy
 size={32}
 aria-hidden="true"
 className="text-warning drop-shadow-sm dark:drop-shadow-[0_0_15px_hsl(var(--warning)/0.4)]"
 />
 </div>
 ...
 className="w-full h-auto py-4 text-muted-foreground hover:text-foreground font-bold uppercase tracking-widest text-xs md:text-xs border border-border bg-muted dark:bg-[hsl(var(--background)/0.03)] rounded-xl transition-all"
 >
