    ...
    <main className="min-h-screen px-4 md:px-8 pt-24 pb-32 bg-cyber-bg relative overflow-hidden">
      ...
      <article className="max-w-4xl mx-auto relative z-10">
        ...
        <header className="mb-16">
          ...
          {lesson.summary && (
            <div className="p-6 md:p-8 rounded-[2rem] bg-gradient-to-r from-cyber-neon/10 to-transparent border-l-4 border-cyber-neon shadow-[inset_0_0_20px_rgba(0,255,239,0.05)]">
              <p className="text-cyber-neon text-lg font-medium tracking-wide leading-relaxed">
                {lesson.summary}
              </p>
            </div>
          )}
            ...
            {lesson.examples && (
              <div className="mt-12 space-y-4">
                <p className="text-[10px] text-white/30 font-black uppercase tracking-[0.4em] mb-6 flex items-center gap-4">
                  ...
                  Query: Reibun <span className="h-[1px] flex-1 bg-white/10" />
                </p>
        ...
        <nav className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-12 border-t border-white/10">
          {prevLesson ? (
            ...
            >
              ...
              <p className="text-[10px] text-cyber-neon uppercase font-black tracking-[0.3em] mb-3 opacity-60 group-hover:opacity-100 transition-opacity">
                ← Previous Module
              </p>
              <h4 className="text-white font-black text-xl leading-tight uppercase italic group-hover:text-cyber-neon transition-colors relative z-10">
                {prevLesson.title}
              </h4>
            </Link>
          ) : (
          ...
          {nextLesson ? (
            ...
            >
              ...
              <p className="text-cyber-neon font-black uppercase text-sm tracking-[0.2em]">
                Level Completed
              </p>
            </Link>
          )}
