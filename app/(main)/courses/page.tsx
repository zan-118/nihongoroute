...
// Variabel animasi untuk item (kartu)
const itemVariants = {
...
export default function CoursesLandingPage() {
  // Data dummy (seharusnya dari fetch Sanity)
        ...
        <motion.section variants={itemVariants} className="mb-16">
          <Link href="/exams" className="group block">
            <motion.div
              ...
              whileTap={{ scale: 0.98 }}
              className="bg-[#0d1117] rounded-[2.5rem] p-8 md:p-12 border border-white/5 shadow-[15px_15px_35px_#050608,-10px_-10px_30px_rgba(255,255,255,0.02)] hover:border-red-500/30 transition-colors"
            >
              <div className="flex flex-col md:flex-row justify-between items-center gap-10">
                <div className="max-w-md text-center md:text-left">
                  <div className="flex items-center justify-center md:justify-start gap-2 mb-4">
                    <span className="w-2 h-2 bg-red-500 rounded-full animate-ping" />
                    <span className="text-red-500 font-black text-[10px] tracking-[0.3em] uppercase">
                      Test Center Live
                    </span>
                  </div>
                ...
                <div className="bg-red-500 text-black p-6 rounded-3xl shadow-[0_0_25px_rgba(239,68,68,0.4)]">
            ...
            {jlptLevels.map((level) => (
              ...
              >
                <Link
                  ...
                  className="group block h-72 bg-gradient-to-br from-[#121620] to-[#0d1117] rounded-[2.5rem] p-8 border border-white/[0.05] shadow-[12px_12px_25px_#050608,-10px_-10px_25px_rgba(255,255,255,0.02)]"
                >
                  <div className="flex flex-col h-full justify-between">
                    <span className="text-5xl font-black italic text-slate-800 group-hover:text-cyan-400 transition-colors">
                      {level}
                    </span>
