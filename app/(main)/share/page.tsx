    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-6 text-center">
        <Card className="p-12 max-w-md w-full neo-card rounded-[2.5rem] border-red-500/20 bg-card">
          ...
          <Button asChild className="w-full h-12 bg-primary rounded-xl font-black uppercase tracking-widest text-[10px]">
        ...
        <Card className="p-8 md:p-16 text-center neo-card rounded-[3.5rem] border border-border bg-card/80 backdrop-blur-xl shadow-2xl relative overflow-hidden">
           ...
           <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
              <div className="p-8 bg-muted/30 border border-border rounded-3xl neo-inset flex flex-col items-center">
                 <span className="text-[9px] font-black text-muted-foreground uppercase tracking-widest block mb-4">Skor Akhir</span>
              ...
              <div className="p-8 bg-muted/30 border border-border rounded-3xl neo-inset flex flex-col items-center">
                 <span className="text-[9px] font-black text-muted-foreground uppercase tracking-widest block mb-4">Akurasi</span>
           ...
           <div className="pt-8 border-t border-border">
              <p className="text-[11px] font-bold text-muted-foreground uppercase tracking-widest mb-8">Ingin mencoba ujian ini juga?</p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                 <Button asChild className="h-14 px-10 bg-primary text-primary-foreground font-black uppercase tracking-widest text-[11px] rounded-2xl shadow-lg hover:shadow-primary/20 transition-all">
                 ...
                 <Button 
                    ...
                    variant="ghost" 
                    className="h-14 px-10 border border-border bg-white/5 hover:bg-white/10 text-foreground font-black uppercase tracking-widest text-[11px] rounded-2xl transition-all"
                 >
           ...
           <div className="mt-12 flex items-center justify-center gap-3 opacity-40">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.4em]">NihongoRoute</span>
           </div>
        </Card>
      </motion.div>
    </div>
...
export default function SharePage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center text-[10px] font-black uppercase tracking-widest text-muted-foreground animate-pulse">Memuat Sertifikat...</div>}>
      <ShareContent />
    </Suspense>
  );
}
