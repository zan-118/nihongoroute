...
export default async function VerbDictionaryPage() {
  ...
  // ======================
  return (
    <main className="w-full bg-background px-6 md:px-12 relative overflow-hidden flex flex-col justify-start min-h-screen pt-24 transition-colors duration-300">
